...
\newcommand{\fitblank}[2][\relax]{%
  ...
  \else
    % 答えが指定されている場合
    \ifshowanswer
      \underline{\hspace{2.5em}{\color{blue}\ensuremath{\bm{#1}}}\hspace{2.5em}}%
    \else
      \underline{\hspace{2.5em}\phantom{\ensuremath{#1}}\hspace{2.5em}}%
    \fi
  \fi
}
