...
\begin{enumerate}[itemsep=1em]
    \item \fitblankfixed[３組の辺がそれぞれ等しい]{30}
    \item \fitblankfixed[２組の辺の比とその間の角がそれぞれ等しい]{30}
    \item \fitblankfixed[２組の角がそれぞれ等しい]{30}
\end{enumerate}
\vspace{1em}
\newpage
...
ここで使用する流れや型は２年次で学習した「合同な図形」の証明においても使用した汎用的なものである。
