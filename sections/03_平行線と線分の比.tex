...
%平行線と線分の比
    \begin{theorembox}[thm:三角形と平行線の比①]{\textbf{三角形と平行線の比①}}
        ...
        \begin{enumerate}
            \item $DE /\!/ BC$ ならば \\
                $\fitblankfixed[AD : AB = AE : AC = DE : BC]{15}$
            \item $DE /\!/ BC$ ならば \\
                $\fitblankfixed[AD : DB = AE : EC]{15}$
        \end{enumerate}
    ...
    \begin{theorembox}[thm:平行線と線分の比]{\textbf{平行線と線分の比}}
        右の図において、３直線 $l, m, n$ が平行であるとき、
        \vspace{0.5em}

        $\fitblankfixed[AB : BC = A'B' : B'C']{15}$
    ...
    \begin{theorembox}[thm:三角形と平行線の比②]{\textbf{三角形と平行線の比②}}
        ...
        \begin{enumerate}
            \item $AD : AB = AE : AC$ ならば \\
                $\fitblankfixed[DB /\!/ EC]{15}$
            \item $AD : DB = AE : EC$ ならば \\
                $\fitblankfixed[DE /\!/ BC]{15}$
        \end{enumerate}
